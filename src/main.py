...
def app():
    def showChart():
        img = Image.open("C:\\Users\\Ashwin\\Desktop\\Programming Portfolio\\Python\\bmiCalc\\img\\bmiChart.png")
        img.show()
    ...
    window.iconbitmap("C:\\Users\\Ashwin\\Desktop\\Programming Portfolio\\Python\\bmiCalc\\icon\\favicon.ico")
